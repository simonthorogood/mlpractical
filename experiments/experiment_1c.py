# Rerun for smaller num_filters for longer

import subprocess

num_epochs = 50
num_layers = 4
num_filters_settings = [16, 32]
dim_reduction_types = ['strided_convolution', 'dilated_convolution']
...
for dm_type  in dim_reduction_types:
    for num_filters in num_filters_settings:
        experiment_name = 'exp1c_{0}_{1}'.format(dm_type, num_filters)
...
dim_reduction_types = ['avg_pooling']
